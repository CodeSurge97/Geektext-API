...
def addFromJson():
    ...
    user1 = User(name='Tomas Ortega', nickname='Toms', username='tomsOrtega', email='torte007@fiu.edu', password=ps1, address='7 Pumpkin Hill St. Fresh Meadows, NY 11365')
    user2 = User(name='Pavlina Richards', nickname='pavv', username='anserinepavlina', email='pavlina_donald@gmail.com', password=ps2, address='9607 Wentworth Drive Muskogee, OK 74403')
    user3 = User(name="Jose O'Connor", nickname='ElJose', username='ashystephen', email='stephenoconnor17@gmail.com', password=ps3, address='6 SE. Cherry Hill Ave. Glendale, AZ 85302')
    user4 = User(name='Justyne Henrietta', nickname='Just-Justyne', username='boldjustyne', email='crunchyjustyne@gmail.com', password=ps4, address='65 Fremont Lane Lady Lake, FL 32159')
    user5 = User(name='Augustina Collins', nickname='August', username='augustinacollins60', email='almondyaugustina@gmail.com', password=ps5, address='40 Bohemia Rd. Muskego, WI 53150')
